...
Future<Response> postRequestCommunicationRequest(
    CommunicationRequest communicationRequest) async {
  ...
  if (emailResponse != null && emailResponse.statusCode > 299) {
    ...
    if (smsResponse != null && smsResponse.statusCode > 299) {
      ...
      return Response.ok('Communication successfully sent via email and SMS.');
    }
  }
}
